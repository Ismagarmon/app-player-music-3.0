...
class ArtistComponent extends LitElement {
    ...
    return html`
        <div class='artistbox '>
          <div class='flex flex-jc'>
            <div class='flex flex-jc'>
              <svg version="1.0" 
                width="30.000000pt" height="27.000000pt" viewBox="0 0 1280.000000 991.000000"
            ...
            <div>
              <p class='partist'>${this.artistName}</p>
            </div>
          </div>
...
customElements.define('artist-component', ArtistComponent);